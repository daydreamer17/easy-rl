...
DEFAULT_OUTPUT_DIR = ROOT_DIR / "outputs" / "cliff_sarsa"
...
def train(env, agent, train_episodes, max_steps, seed=None):
    ...
    for episode_idx in range(train_episodes):
        ...
        for _ in range(max_steps):
            ...
            next_action = None if done else agent.sample(next_state)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Sarsa demo for CliffWalking-v0")
